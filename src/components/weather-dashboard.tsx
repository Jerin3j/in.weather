    ...
    <div className="p-4 space-y-4">
      {error === "invalid-city" && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Please enter a valid location. We couldn't find the weather for this
            city.
          </AlertDescription>
        </Alert>
      )}
      ...
      {error === "location-denied" && (
        <Alert onClick={() => window.location.reload()}
           variant="destructive">
          <AlertTitle>Location Access Denied</AlertTitle>
          <AlertDescription className="text-red-400">
            Location access was denied. Please enable it or manually enter
            location to see weather updates for your current location.
          </AlertDescription>
        </Alert>
      )}
